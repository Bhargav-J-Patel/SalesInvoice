<%@ Page Title="" Language="C#" MasterPageFile="~/BillMaster.master" AutoEventWireup="true" CodeFile="ListTranPurchaseInvoiceReturn.aspx.cs" Inherits="ListTranPurchaseInvoiceReturn" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var oTable = $('#datatable').DataTable({
                ...
                bServerSide: true,
                sAjaxSource: 'ListPage.asmx/ListPurchaseReturn',
                sServerMethod: 'post',
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="panel">
        <div class="panel-heading">
            <h2 class="panel-title">List Purchase Return
               <%-- <button type="button" name="btnList" runat="server" id="btnList" class="btn btn-info AddList"
                ...
                <button type="button" name="btnAdd" runat="server" id="btnAdd" class="btn btn-success AddList"
                    onclick="location.href = 'TranPurchaseInvoiceReturn.aspx'" tabindex="5" style="float: right; margin-right: 4px;">
                        ...
                        <table id="datatable" width="100%" area-describedby="datatable_info" cellspacing="1px"
                            ...
                            <thead>
                                <tr style="background-color: #2A3F54; color: #fff; height: 34px;">
                                    ...
                                    <th style="width: 150px; padding: 5px 0px 5px 5px;">Date
                                    </th>
                                    <th style="padding: 5px 0px 5px 5px;">Name
                                    </th>
                                    <th style="width: 200px; padding: 5px 0px 5px 5px;">Gross Rs
                                    </th>
                                    <th style="width: 200px; padding: 5px 0px 5px 5px;">Net Rs
                                    </th>
