<%@ Page Title="Payment" Language="C#" MasterPageFile="~/BillMaster.master" AutoEventWireup="true" CodeFile="TranPayment.aspx.cs" Inherits="TranPayment" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function ScuessMsg(type, ID) {
            if (type == 'PU' && ID != '') {
                alertify.alert("You have Sucessfully Add Payment !!", function () {
                    location.href = 'TranPayment.aspx';
                });
            }
            else if (type == 'D' && ID == 'D') {
                alertify.alert("You have Sucessfully Delete Payment! !", function () {
                    location.href = 'ListTranpayment.aspx';
                });
            }
            else {
                alertify.alert("You have Sucessfully Update Payment ! !", function () {
                    location.href = 'ListTranpayment.aspx';
                });
            }
        ...
        <div class="panel-heading">
            <h2 class="panel-title">
                ...
                <button type="button" name="btnList" id="btnList" runat="server" class="btn btn-info AddList"
                    onclick="location.href = 'ListTranPayment.aspx'" tabindex="15" style="float: right;">
                ...
                <button type="button" name="btnAdd" id="btnAdd" runat="server" class="btn btn-success AddList"
                    onclick="location.href = 'TranPayment.aspx'" tabindex="16" style="float: right;
                    margin-right: 4px;">
                ...
                <ContentTemplate>
                    <table class="table1">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList runat="server" ID="DDLAgainstBill">
                                    <asp:ListItem>Yes</asp:ListItem>
                                    <asp:ListItem>No</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td style="display:none">
                                <asp:TextBox runat="server" ID="TxtKasar" CssClass="bsinputred" TabIndex="6" />
                            </td>
                            <td style="display:none">
                                <asp:TextBox runat="server" ID="TxtTDS" CssClass="bsinputred" TabIndex="7" />
                            </td>
                            <td>
                                <asp:TextBox runat="server" ID="TxtRefNO" CssClass="bsinputblue" TabIndex="8" />
                            </td>
                             <td>
                                
                                <asp:TextBox runat="server" ID="TxtRefdate" CssClass="bsdate_picker" TabIndex="9" onkeydown="return validateKeyPress(event,validDt)"
                            OnChange="dateval(this);" MaxLength="10" data-inputmask="'mask': '99/99/9999'"
                            Width="120px" />
                        <cc1:CalendarExtender runat="server" ID="CalendarExtender1" TargetControlID="TxtRefdate"
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="TxtRemarks" CssClass="bsinputblue" TabIndex="10" />
                            </td>
                            <td>
                                <asp:ImageButton ID="ImgBtnAdd" ImageUrl="assets/img/add.png" runat="server" TabIndex="11"
                ...
                <asp:GridView ID="GVItem" runat="server" AutoGenerateColumns="false" class="table1 table-responsive table-bordered table-hover">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Edit" ItemStyle-Width="5%">
                            <ItemTemplate>
                                <a href="TranPayment.aspx?id=<%# DataBinder.Eval(Container.DataItem,"cPNID")%>&cid=<%# DataBinder.Eval(Container.DataItem , "NID") %>">
                ...
                <button type="button" name="btnCancel" id="btnCancel" class="btn btn-info SaveCancel btnCancel"
                    ...
                    <i class="icon fa-close SaveCancelIcon iCancel"></i><span id="spanCancel" class="spanCancel">
                        ...
                        <asp:Button runat="server" ID="btnsave" class="btn btn-success SaveCancel btnSave"
                            OnClick="btnsave_Click" Text="Save" TabIndex="12" />
                        <asp:Button runat="server" ID="btncancel" class="btn btn-info SaveCancel btnCancel"
                            Text="Cancel" TabIndex="13" OnClick="btncancel_Click" />
