<%@ Page Title="Sales Invoice" Language="C#" MasterPageFile="~/BillMaster.master" AutoEventWireup="true" CodeFile="TranSalesRetailInvoice.aspx.cs" Inherits="TranSalesRetailInvoice" %>
        ...
        function ScuessMsg(type, ID) {
            if (type == 'PU' && ID != '') {
                alertify.alert("You have Sucessfully Add Sales Invoice", function () {
                    location.href = 'TranSalesRetailInvoice.aspx';
                });
            }
            else if (type == 'D' && ID == 'D') {
                alertify.alert("You have Sucessfully Delete Sales Invoice! !", function () {
                    location.href = 'ListTranSalesRetailInvoice.aspx';
                });
            }
            else {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="panel">
        <div class="panel-heading">
            <h2 class="panel-title">Sales Invoice (Include)
                <button type="button" name="btnList" id="btnList" runat="server" class="btn btn-info AddList"
                    onclick="location.href = 'ListTranSalesRetailInvoice.aspx'" tabindex="6015" style="float: right;">
                ...
                <button type="button" name="btnAdd" id="btnAdd" runat="server" class="btn btn-success AddList"
                    onclick="location.href = 'TranSalesRetailInvoice.aspx'" tabindex="6014" style="float: right; margin-right: 4px;">
            ...
            <table class="table1">
                <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox runat="server" ID="TxtCustomer" CssClass="bsinputgreen" TabIndex="2"
                        ...
                        <asp:DropDownList ID="DDLCashCredit" runat="server" TabIndex="2">
                    ...
                    <td>
                        ...
                        <asp:TextBox runat="server" ID="TxtTransporterID" CssClass="bsinputblue" TabIndex="3"
                            Style="width: 120px; display: none" />
                    </td>
                    <td>
                        <%--<strong class="contentLabel">Transporter Name</strong>--%>
                        <asp:TextBox runat="server" ID="TxtTransporterName" CssClass="bsinputblue" TabIndex="4"
                            Style="width: 120px; display: none" />
                    </td>
                    <td>
                        <%--<strong class="contentLabel">VehicleNo</strong>--%>
                        <asp:TextBox runat="server" ID="TxtVehicleNo" CssClass="bsinputblue" TabIndex="5"
                        ...
                        <tr>
                            ...
                            <td width="265px">
                                <asp:TextBox runat="server" ID="TxtItemName" CssClass="bsinputgreen" AutoPostBack="true"
                                    Style="background: #E6f2f2; border: 1px solid DarkGray; border-radius: 3px; height: 22px;"
                                    Width="250px" TabIndex="6" OnTextChanged="TxtItemName_TextChanged" />
                            ...
                            <td width="265px">
                                <asp:TextBox runat="server" ID="TxtItemGroupName" CssClass="bsinputgreen" TabIndex="7"
                            ...
                            <td width="275px">
                                <asp:TextBox runat="server" ID="TxtDescription" CssClass="bsinputblue" TabIndex="8"
                                    Width="250px" Enabled="false" />
                            </td>
                            <td width="160px" style="display: none">
                                <asp:TextBox runat="server" ID="TxtSize" CssClass="bsinputblue" TabIndex="9" Enabled="false"
                                    Width="150px" />
                            </td>
                            <td>
                                <asp:TextBox runat="server" ID="TxtMRP" CssClass="bsinputred" TabIndex="10" Enabled="false" />
                            </td>
                            <td>
                                <asp:TextBox runat="server" ID="txtDiscPerChild" CssClass="bsinputred" TabIndex="11" OnTextChanged="txtDiscPerChild_TextChanged" AutoPostBack="true" />
                            </td>
                            <td>
                                <asp:TextBox runat="server" ID="TxtDisRsChild" CssClass="bsinputred" TabIndex="12" OnTextChanged="TxtDisRsChild_TextChanged" Enabled="false" />
                            </td>
                            <td>
                                <asp:TextBox runat="server" ID="TxtSaleRate" CssClass="bsinputred" TabIndex="13" OnTextChanged="TxtSaleRate_TextChanged" AutoPostBack="true" />
                            </td>
                            <td>
                                <asp:TextBox runat="server" ID="TxtQty" CssClass="bsinputred" TabIndex="14" AutoPostBack="true"
                            ...
                            <td>
                                <asp:ImageButton ID="ImgBtnAdd" ImageUrl="assets/img/add.png" runat="server" TabIndex="15"
                ...
                <ContentTemplate>
                    <div class="col-lg-12 col-md-12 col-sm-12" style="border-top: 1px solid grey;">
                        ...
                        <div class="col-lg-1 col-md-1 col-sm-1 inputCenter">
                            <asp:TextBox runat="server" ID="TxtVatPer" CssClass="bsinputred" TabIndex="16" AutoPostBack="true" Style="display: none"
                                OnTextChanged="TxtVatPer_TextChanged" />
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 inputLeft">
                            <asp:TextBox runat="server" ID="TxtVatRs" CssClass="bsinputred" TabIndex="17" Enabled="false" />
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="col-lg-1 col-md-1 col-sm-1 inputCenter">
                            <asp:TextBox runat="server" ID="TxtExtraPer" CssClass="bsinputred" TabIndex="18" AutoPostBack="true" Style="display: none"
                                OnTextChanged="TxtExtraPer_TextChanged" />
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 inputLeft">
                            <asp:TextBox runat="server" ID="TxtExtraRs" CssClass="bsinputred" TabIndex="18" Enabled="false" />
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="col-lg-2 col-md-2 col-sm-2" style="text-align: center;">
                        ...
                        <div class="col-lg-1 col-md-1 col-sm-1 inputCenter">
                            <asp:TextBox runat="server" ID="TxtIGSTPer" CssClass="bsinputred" TabIndex="19" AutoPostBack="true" Style="display: none"
                                OnTextChanged="TxtExtraPer_TextChanged" />
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 inputLeft">
                            <asp:TextBox runat="server" ID="TxtIGST" CssClass="bsinputred" TabIndex="19" Enabled="false" />
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="col-lg-2 col-md-2 col-sm-2" style="text-align: center;">
                        ...
                        <div class="col-lg-1 col-md-1 col-sm-1 inputCenter">
                            <asp:TextBox runat="server" ID="TextBox1" CssClass="bsinputred" TabIndex="20" AutoPostBack="true"
                                OnTextChanged="TxtExtraPer_TextChanged" Visible="false" />
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 inputLeft">
                            <asp:TextBox runat="server" ID="LblAmt" CssClass="bsinputred" TabIndex="20" Enabled="false" />
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12" style="display: none">
                        ...
                        <div class="col-lg-1 col-md-1 col-sm-1 inputRight" style="text-align: right;">
                            <asp:TextBox runat="server" ID="TxtDisPer" CssClass="bsinputred" TabIndex="21" AutoPostBack="true"
                                OnTextChanged="TxtDisPer_TextChanged" />
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 inputLeft">
                            <asp:TextBox runat="server" ID="TxtDisRs" CssClass="bsinputred" TabIndex="21" AutoPostBack="true" OnTextChanged="TxtDisRS_TextChanged" />
                        </div>
                    </div>
                ...
                <button type="button" name="btnCancel" id="btnCancel" class="btn btn-info SaveCancel btnCancel"
                    ...
                    <i class="icon fa-close SaveCancelIcon iCancel"></i><span id="spanCancel" class="spanCancel">
                        ...
                        <asp:Button runat="server" ID="btnsave" class="btn btn-success SaveCancel btnSave"
                            OnClick="btnsave_Click" Text="Save" TabIndex="22" />
                        <asp:Button runat="server" ID="btncancel" class="btn btn-info SaveCancel btnCancel"
                            Text="Cancel" TabIndex="23" OnClick="btncancel_Click" />
