<%@ Page Title="" Language="C#" MasterPageFile="~/BillMaster.master" AutoEventWireup="true" CodeFile="TranPurchaseInvoiceInclude.aspx.cs" Inherits="TranPurchaseInvoiceInclude" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="panel">
        <div class="panel-heading">
            <h2 class="panel-title">Purchase(Include)
                <button type="button" name="btnList" id="btnList" runat="server" class="btn btn-info AddList"
                    onclick="location.href = 'ListTranPurchaseInvoiceInclude.aspx'" tabindex="6015" style="float: right;">
