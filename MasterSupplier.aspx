<%@ Page Title="Supplier" Language="C#" MasterPageFile="~/BillMaster.master" AutoEventWireup="true" CodeFile="MasterSupplier.aspx.cs" Inherits="MasterSupplier" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
 <script type="text/javascript">
     ...
     function ScuessMsg(type) {
         ...
         if (type == 'I') {
             alertify.alert("You have Sucessfully Add Supplier", function () {
                 location.href = 'MasterSupplier.aspx';
             });
         }
         if (type == 'U') {
             alertify.alert("You have Sucessfully Update Supplier", function () {
                 location.href = 'ListMasterSupplier.aspx';
             });
         }
         if (type == 'D') {
             alertify.alert("You have Sucessfully Delete Supplier", function () {
                 location.href = 'ListMasterSupplier.aspx';
             });
         }
     }
        ...
        <div class="panel-heading">
            <h2 class="panel-title">
                ...
                <button type="button" name="btnList" runat="server" id="btnList" class="btn btn-info AddList"
                    onclick="location.href = 'ListMasterSupplier.aspx'" tabindex="16" style="float: right;">
