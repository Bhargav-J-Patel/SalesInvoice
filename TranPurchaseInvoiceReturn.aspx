<%@ Page Title="Purchase Return" Language="C#" MasterPageFile="~/BillMaster.master" AutoEventWireup="true" CodeFile="TranPurchaseInvoiceReturn.aspx.cs" Inherits="TranPurchaseInvoiceReturn" %>
    ...
    function ScuessMsg(type, ID) {
        if (type == 'PU' && ID != '') {
            alertify.alert("You have Sucessfully Add Purchase Invoice", function () {
                location.href = 'TranPurchaseInvoiceReturn.aspx';
            });
        }
        else if (type == 'D' && ID == 'D') {
            alertify.alert("You have Sucessfully Delete Purchase Invoice! !", function () {
                location.href = 'ListTranPurchaseInvoiceReturn.aspx';
            });
        }
        else {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="panel">
        <div class="panel-heading">
            <h2 class="panel-title">Purchase Invoice Return
                <button type="button" name="btnList" id="btnList" runat="server" class="btn btn-info AddList"
                    onclick="location.href = 'ListTranPurchaseInvoiceReturn.aspx'" tabindex="6015" style="float: right;">
                ...
                <button type="button" name="btnAdd" id="btnAdd" runat="server" class="btn btn-success AddList"
                    onclick="location.href = 'TranPurchaseInvoiceReturn.aspx'" tabindex="6014" style="float: right; margin-right: 4px;">
                ...
                <asp:GridView ID="GVItem" runat="server" AutoGenerateColumns="false" class="table1 table-responsive table-bordered table-hover">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Edit" ItemStyle-Width="5%">
                            <ItemTemplate>
                                <a href="TranPurchaseInvoiceReturn.aspx?id=<%# DataBinder.Eval(Container.DataItem,"cPNID")%>&cid=<%# DataBinder.Eval(Container.DataItem , "NID") %>">
