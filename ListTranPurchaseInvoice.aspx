<%@ Page Title="" Language="C#" MasterPageFile="~/BillMaster.master" AutoEventWireup="true" CodeFile="ListTranPurchaseInvoice.aspx.cs" Inherits="ListTranPurchaseInvoice" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var oTable = $('#datatable').DataTable({
                ...
                bServerSide: true,
                sAjaxSource: 'ListPage.asmx/ListPurchase',
                sServerMethod: 'post',
            ...
            <h2 class="panel-title">List Purchase(Exculde)
               <%-- <button type="button" name="btnList" runat="server" id="btnList" class="btn btn-info AddList"
                ...
                <button type="button" name="btnAdd" runat="server" id="btnAdd" class="btn btn-success AddList"
                    onclick="location.href = 'TranPurchaseInvoice.aspx'" tabindex="5" style="float: right; margin-right: 4px;">
