<%@ Page Title="Sales Retail Return" Language="C#" MasterPageFile="~/BillMaster.master" AutoEventWireup="true" CodeFile="TranSalesRetailInvoiceReturn.aspx.cs" Inherits="TranSalesRetailInvoiceReturn" %>
        ...
        function ScuessMsg(type, ID) {
            if (type == 'PU' && ID != '') {
                alertify.alert("You have Sucessfully Add Sales Invoice", function () {
                    location.href = 'TranSalesRetailInvoiceReturn.aspx';
                });
            }
            else if (type == 'D' && ID == 'D') {
                alertify.alert("You have Sucessfully Delete Sales Invoice! !", function () {
                    location.href = 'ListTranSalesRetailInvoiceReturn.aspx';
                });
            }
            else {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="panel">
        <div class="panel-heading">
            <h2 class="panel-title">Sales Return(Include)
                <button type="button" name="btnList" id="btnList" runat="server" class="btn btn-info AddList"
                    onclick="location.href = 'ListTranSalesRetailInvoiceReturn.aspx'" tabindex="6015" style="float: right;">
                ...
                <button type="button" name="btnAdd" id="btnAdd" runat="server" class="btn btn-success AddList"
                    onclick="location.href = 'TranSalesRetailInvoiceReturn.aspx'" tabindex="6014" style="float: right; margin-right: 4px;">
                ...
                <asp:GridView ID="GVItem" runat="server" AutoGenerateColumns="false" class="table1 table-responsive table-bordered table-hover">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Edit" ItemStyle-Width="5%">
                            <ItemTemplate>
                                <a href="TranSalesRetailInvoiceReturn.aspx?id=<%# DataBinder.Eval(Container.DataItem,"cPNID")%>&cid=<%# DataBinder.Eval(Container.DataItem , "NID") %>">
