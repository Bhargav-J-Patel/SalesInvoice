<%@ Page Title="Sales Invoice Tax" Language="C#" MasterPageFile="~/BillMaster.master" AutoEventWireup="true" CodeFile="TranSalesInvoice.aspx.cs" Inherits="TranSalesInvoice" %>
        ...
        function ScuessMsg(type, ID) {
            if (type == 'PU' && ID != '') {
                alertify.alert("You have Sucessfully Add Sales Invoice", function () {
                    location.href = 'TranSalesInvoice.aspx';
                });
            }
            else if (type == 'D' && ID == 'D') {
                alertify.alert("You have Sucessfully Delete Sales Invoice! !", function () {
                    location.href = 'ListTranSalesTaxInvoice.aspx';
                });
            }
            else {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="panel">
        <div class="panel-heading">
            <h2 class="panel-title">Sales Invoice(Exclue)
                ...
                <button type="button" name="btnAdd" id="btnAdd" runat="server" class="btn btn-success AddList"
                    onclick="location.href = 'TranSalesInvoice.aspx'" tabindex="6014" style="float: right; margin-right: 4px;">
                ...
                <asp:GridView ID="GVItem" runat="server" AutoGenerateColumns="false" class="table1 table-responsive table-bordered table-hover">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Edit" ItemStyle-Width="5%">
                            <ItemTemplate>
                                <a href="TranSalesInvoice.aspx?id=<%# DataBinder.Eval(Container.DataItem,"cPNID")%>&cid=<%# DataBinder.Eval(Container.DataItem , "NID") %>">
