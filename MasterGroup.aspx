...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="panel">
        <div class="panel-heading">
            <h2 class="panel-title">Group Master
                <button type="button" name="btnList" runat="server" id="btnList" class="btn btn-info AddList"
                    onclick="location.href = 'ListMasterGroup.aspx'" tabindex="7" style="float: right;">
        ...
        <div class="panel-content marginTopContent">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        <asp:TextBox runat="server" ID="TxtGroupCode" CssClass="bsinputblue" TabIndex="1" Width="150px" />
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        <asp:TextBox runat="server" ID="TxtGroupName" CssClass="bsinputblue" TabIndex="2" />
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-10">
                        <strong class="contentLabel">Group Type</strong>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        <asp:DropDownList runat="server" ID="DDLGroupType" TabIndex="4" CssClass="bsinputblue" Style="width: 150px;">
                            <asp:ListItem></asp:ListItem>
                            <asp:ListItem>Balance Sheet</asp:ListItem>
                            <asp:ListItem>Profit & Loss</asp:ListItem>
                            <asp:ListItem>Trading Account</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                    </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        <asp:DropDownList runat="server" ID="DDLAccType" TabIndex="4" CssClass="bsinputblue" Style="width: 150px;">
                            ...
                            <asp:ListItem Value="2">Customer/Supplier</asp:ListItem>
                            ...
                            <asp:ListItem Value="7">Sales</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                    </div>
