...
public partial class TranReceipt : System.Web.UI.Page
{
    ...
    protected void ImgDelete1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (confirmval == "Yes")
            {
                ...
                ds = cn.RunSql("sp_addreceipt 'PUCD','0','" + TxtSRNo.Text + "','" + TxtDate.Text + "','" + DDLCType.SelectedValue + "','" + HifCustomer.Value + "','','','','','','','','','" + Request.QueryString["id"] + "','" + cnid + "','" + Request.Cookies["CompID"].Value + "','" + Request.Cookies["BranchID"].Value + "','" + Request.Cookies["AccYear"].Value + "','" + Request.Cookies["loginid"].Value + "'", "puci");
                Response.Redirect("TranReceipt.aspx?id=" + ds.Tables[0].Rows[0][0] + "");
            }
        }
        catch (Exception ex)
        {
        ...
        try
        {
            ...
            if (Request.QueryString["D"] == "1")
            {
                if (ddldelete.SelectedValue == "Yes")
                {
                    ...
                    ds = cn.RunSql("sp_addreceipt 'd','0','" + TxtSRNo.Text + "','" + TxtDate.Text + "','" + DDLCType.SelectedValue + "','" + HifCustomer.Value + "','" + HIFAccount.Value + "','" + TxtAmount.Text + "','" + DDLAgainstBill.SelectedValue + "','" + TxtKasar.Text + "','" + TxtTDS.Text + "','" + TxtRefNO.Text + "','" + TxtRefdate.Text + "','" + TxtRemarks.Text + "','" + Request.QueryString["id"] + "','','" + Request.Cookies["CompID"].Value + "','" + Request.Cookies["BranchID"].Value + "','" + Request.Cookies["AccYear"].Value + "','" + Request.Cookies["loginid"].Value + "'", "puci");
            ...
            else
            {
                ...
                ds = cn.RunSql("sp_addreceipt 'PU','0','" + TxtSRNo.Text + "','" + TxtDate.Text + "','" + DDLCType.SelectedValue + "','" + HifCustomer.Value + "','','','','','','','','','" + Request.QueryString["id"] + "','','" + Request.Cookies["CompID"].Value + "','" + Request.Cookies["BranchID"].Value + "','" + Request.Cookies["AccYear"].Value + "','" + Request.Cookies["loginid"].Value + "'", "puci");
