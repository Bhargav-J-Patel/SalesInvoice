<%@ Page Title="" Language="C#" MasterPageFile="~/BillMaster.master" AutoEventWireup="true" CodeFile="MasterAcccount.aspx.cs" Inherits="MasterAcccount" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
 <script type="text/javascript">
     ...
     function ScuessMsg(type) {
         ...
         if (type == 'I') {
             alertify.alert("You have Sucessfully Add Account", function () {
                 location.href = 'MasterAcccount.aspx';
             });
         }
         if (type == 'U') {
             alertify.alert("You have Sucessfully Update Account", function () {
                 location.href = 'ListMasterAccount.aspx';
             });
         }
         if (type == 'D') {
             alertify.alert("You have Sucessfully Delete Account", function () {
                 location.href = 'ListMasterAccount.aspx';
             });
         }
     }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="panel">
        <div class="panel-heading">
            <h2 class="panel-title">
                ...
                <button type="button" name="btnList" runat="server" id="btnList" class="btn btn-info AddList"
                    onclick="location.href = 'ListMasterAccount.aspx'" tabindex="16" style="float: right;">
        ...
        col-md-12 col-sm-12">
                    <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
                        <strong class="contentLabel">Account Group</strong>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-3
        col-xs-12">
                       <asp:DropDownList runat="server" id="DDLAcGroup" CssClass="bsinputblue" DataTextField="cGroupName" DataValueField="NID"></asp:DropDownList>
                    </div>
                    <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
                        <strong class="contentLabel">A/C Type</strong>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-3
        col-xs-12">
                       <asp:DropDownList runat="server" ID="DDLAcType" CssClass="bsinputblue">
                      
                       <asp:ListItem Value="3">Bank</asp:ListItem>
                       <asp:ListItem Value="4">Cash</asp:ListItem>
