<%@ Page Title="Purchase Invoice" Language="C#" MasterPageFile="~/BillMaster.master" AutoEventWireup="true" CodeFile="TranPurchaseInvoice.aspx.cs" Inherits="TranPurchaseInvoice " %>
        ...
        function ScuessMsg(type, ID) {
            if (type == 'PU' && ID != '') {
                alertify.alert("You have Sucessfully Add Purchase Invoice", function () {
                    location.href = 'TranPurchaseInvoice.aspx';
                });
            }
            else if (type == 'D' && ID == 'D') {
                alertify.alert("You have Sucessfully Delete Purchase Invoice! !", function () {
                    location.href = 'ListTranPurchaseInvoice.aspx';
                });
            }
            else {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="panel">
        <div class="panel-heading">
            <h2 class="panel-title">Purchase (Exclude)
                <button type="button" name="btnList" id="btnList" runat="server" class="btn btn-info AddList"
                    onclick="location.href = 'ListTranPurchaseInvoice.aspx'" tabindex="6015" style="float: right;">
