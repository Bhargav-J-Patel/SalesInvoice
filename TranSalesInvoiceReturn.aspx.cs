...
public partial class TranSalesInvoiceReturn : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (IsPostBack == false)
        {
            try
            {
                ...
                ds = cn.RunSql("sp_getsrno '0','3','" + Request.Cookies["CompID"].Value + "','" + Request.Cookies["BranchID"].Value + "','" + Request.Cookies["AccYear"].Value + "'", "select");
                ...
                if (Request.QueryString["id"] != null)
                {
                    ...
                    if (Request.QueryString["cid"] != null)
                    {
                        ...
                        TxtMRP.Text = ds.Tables[3].Rows[0]["nMRP"] != DBNull.Value ? ds.Tables[3].Rows[0]["nMRP"].ToString() : "";
                        ...
                        TxtSaleRate.Text = ds.Tables[3].Rows[0]["nSaleRate"] != DBNull.Value ? ds.Tables[3].Rows[0]["nSaleRate"].ToString() : "";
    ...
    protected void ImgBtnAdd_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            if (Request.QueryString["id"] != null)
            {
                if (Request.QueryString["cid"] != null)
                {
                    ds = cn.RunSql("sp_addcsalestrans 'PUCU','3','" + TxtSRNo.Text + "','" + TxtDate.Text + "','" + HifCustomer.Value + "','" + HifItem.Value + "','" + TxtQty.Text + "','" + LblTotal.Text + "','" + LblGrossRs.Text + "','" + TxtVatPer.Text + "','" + TxtVatRs.Text + "','" + TxtExtraPer.Text + "','" + TxtExtraRs.Text + "','" + TxtDisPer.Text + "','" + TxtDisRs.Text + "','" + LblNetRs.Text + "','" + LblAmt.Text + "','" + Request.QueryString["id"] + "','" + Request.QueryString["cid"] + "','" + Request.Cookies["CompID"].Value + "','" + Request.Cookies["BranchID"].Value + "','" + Request.Cookies["AccYear"].Value + "','" + TxtTransporterID.Text + "','" + TxtTransporterName.Text + "','" + TxtVehicleNo.Text + "','" + TxtMRP.Text + "','" + txtDiscPerChild.Text + "','" + TxtDisRsChild.Text + "','" + TxtSaleRate.Text + "','" + DDLCashCredit.SelectedValue + "','" + str + "'", "puci");
                    Response.Redirect("TranSalesInvoiceReturn.aspx?id=" + ds.Tables[0].Rows[0][0] + "&E=1");
                }
                else
                {
                    ds = cn.RunSql("sp_addcsalestrans 'PUCI','3','" + TxtSRNo.Text + "','" + TxtDate.Text + "','" + HifCustomer.Value + "','" + HifItem.Value + "','" + TxtQty.Text + "','" + LblTotal.Text + "','" + LblGrossRs.Text + "','" + TxtVatPer.Text + "','" + TxtVatRs.Text + "','" + TxtExtraPer.Text + "','" + TxtExtraRs.Text + "','" + TxtDisPer.Text + "','" + TxtDisRs.Text + "','" + LblNetRs.Text + "','" + LblAmt.Text + "','" + Request.QueryString["id"] + "','','" + Request.Cookies["CompID"].Value + "','" + Request.Cookies["BranchID"].Value + "','" + Request.Cookies["AccYear"].Value + "','" + TxtTransporterID.Text + "','" + TxtTransporterName.Text + "','" + TxtVehicleNo.Text + "','" + TxtMRP.Text + "','" + txtDiscPerChild.Text + "','" + TxtDisRsChild.Text + "','" + TxtSaleRate.Text + "','" + DDLCashCredit.SelectedValue + "','" + str + "'", "puci");
                    Response.Redirect("TranSalesInvoiceReturn.aspx?id=" + ds.Tables[0].Rows[0][0] + "&E=1");
                }
            }
            else
            {
                ds = cn.RunSql("sp_addcsalestrans 'I','3','" + TxtSRNo.Text + "','" + TxtDate.Text + "','" + HifCustomer.Value + "','" + HifItem.Value + "','" + TxtQty.Text + "','" + LblTotal.Text + "','" + LblGrossRs.Text + "','" + TxtVatPer.Text + "','" + TxtVatRs.Text + "','" + TxtExtraPer.Text + "','" + TxtExtraRs.Text + "','" + TxtDisPer.Text + "','" + TxtDisRs.Text + "','" + LblNetRs.Text + "','" + LblAmt.Text + "','','','" + Request.Cookies["CompID"].Value + "','" + Request.Cookies["BranchID"].Value + "','" + Request.Cookies["AccYear"].Value + "','" + TxtTransporterID.Text + "','" + TxtTransporterName.Text + "','" + TxtVehicleNo.Text + "','" + TxtMRP.Text + "','" + txtDiscPerChild.Text + "','" + TxtDisRsChild.Text + "','" + TxtSaleRate.Text + "','" + DDLCashCredit.SelectedValue + "','" + str + "'", "puci");
                Response.Redirect("TranSalesInvoiceReturn.aspx?id=" + ds.Tables[0].Rows[0][0] + "&E=1");
            }
        }
        catch (Exception ex)
    ...
    protected void ImgDelete1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (confirmval == "Yes")
            {
                ...
                ds = cn.RunSql("sp_addcsalestrans 'PUCD','3','" + TxtSRNo.Text + "','" + TxtDate.Text + "','" + HifCustomer.Value + "','" + HifItem.Value + "','" + TxtQty.Text + "','" + LblTotal.Text + "','" + LblGrossRs.Text + "','" + TxtVatPer.Text + "','" + TxtVatRs.Text + "','" + TxtExtraPer.Text + "','" + TxtExtraRs.Text + "','" + TxtDisPer.Text + "','" + TxtDisRs.Text + "','" + LblNetRs.Text + "','" + LblAmt.Text + "','" + Request.QueryString["id"] + "','" + cnid + "','" + Request.Cookies["CompID"].Value + "','" + Request.Cookies["BranchID"].Value + "','" + Request.Cookies["AccYear"].Value + "','" + TxtTransporterID.Text + "','" + TxtTransporterName.Text + "','" + TxtVehicleNo.Text + "','" + TxtMRP.Text + "','" + txtDiscPerChild.Text + "','" + TxtDisRsChild.Text + "','" + TxtSaleRate.Text + "','" + DDLCashCredit.SelectedValue + "','" + str + "'", "puci");
                Response.Redirect("TranSalesInvoiceReturn.aspx?id=" + ds.Tables[0].Rows[0][0] + "");
            }
        }
        catch (Exception ex)
        {
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Request.QueryString["D"] == "1")
            {
                ...
                {
                    ds = cn.RunSql("sp_addcsalestrans 'd','3','" + TxtSRNo.Text + "','" + TxtDate.Text + "','" + HifCustomer.Value + "','" + HifItem.Value + "','" + TxtQty.Text + "','" + LblTotal.Text + "','" + LblGrossRs.Text + "','" + TxtVatPer.Text + "','" + TxtVatRs.Text + "','" + TxtExtraPer.Text + "','" + TxtExtraRs.Text + "','" + TxtDisPer.Text + "','" + TxtDisRs.Text + "','" + LblNetRs.Text + "','" + LblAmt.Text + "','" + Request.QueryString["id"] + "','','" + Request.Cookies["CompID"].Value + "','" + Request.Cookies["BranchID"].Value + "','" + Request.Cookies["AccYear"].Value + "','" + TxtTransporterID.Text + "','" + TxtTransporterName.Text + "','" + TxtVehicleNo.Text + "','" + TxtMRP.Text + "','" + txtDiscPerChild.Text + "','" + TxtDisRsChild.Text + "','" + TxtSaleRate.Text + "','" + DDLCashCredit.SelectedValue + "','" + str + "'", "puci");
                    ScriptManager.RegisterStartupScript(Page, Page.GetType(), "text", "ScuessMsg('D','D')", true);
                    //Response.Redirect("TranSalesInvoice.aspx");
                }
            }
            else
            {

                ds = cn.RunSql("sp_addcsalestrans 'PU','3','" + TxtSRNo.Text + "','" + TxtDate.Text + "','" + HifCustomer.Value + "','" + HifItem.Value + "','" + TxtQty.Text + "','" + LblTotal.Text + "','" + LblGrossRs.Text + "','" + TxtVatPer.Text + "','" + TxtVatRs.Text + "','" + TxtExtraPer.Text + "','" + TxtExtraRs.Text + "','" + TxtDisPer.Text + "','" + TxtDisRs.Text + "','" + LblNetRs.Text + "','" + LblAmt.Text + "','" + Request.QueryString["id"] + "','','" + Request.Cookies["CompID"].Value + "','" + Request.Cookies["BranchID"].Value + "','" + Request.Cookies["AccYear"].Value + "','" + TxtTransporterID.Text + "','" + TxtTransporterName.Text + "','" + TxtVehicleNo.Text + "','" + TxtMRP.Text + "','" + txtDiscPerChild.Text + "','" + TxtDisRsChild.Text + "','" + TxtSaleRate.Text + "','" + DDLCashCredit.SelectedValue + "','" + str + "'", "puci");
                //Response.Redirect("TranSalesInvoice.aspx");
    ...
    protected void TxtVatPer_TextChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            TxtVatRs.Text = (Convert.ToDouble((Convert.ToDouble(LblGrossRs.Text) * Convert.ToDouble(TxtVatPer.Text) / 100))).ToString("0.00");
            LblAmt.Text = (Convert.ToDouble(LblGrossRs.Text) + Convert.ToDouble(TxtVatRs.Text) + Convert.ToDouble(TxtExtraRs.Text)).ToString("0.00");
            LblNetRs.Text = (Convert.ToDouble(LblAmt.Text) - Convert.ToDouble(TxtDisRs.Text)).ToString("0.00");
    ...
    protected void TxtExtraPer_TextChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            TxtExtraRs.Text = (Convert.ToDouble((Convert.ToDouble(LblGrossRs.Text) * Convert.ToDouble(TxtExtraPer.Text) / 100))).ToString("0.00");
            LblAmt.Text = (Convert.ToDouble(LblGrossRs.Text) + Convert.ToDouble(TxtVatRs.Text) + Convert.ToDouble(TxtExtraRs.Text)).ToString("0.00");
            LblNetRs.Text = (Convert.ToDouble(LblAmt.Text) - Convert.ToDouble(TxtDisRs.Text)).ToString("0.00");
        }
        catch (Exception ex)
    ...
    protected void TxtDisPer_TextChanged(object sender, EventArgs e)
    {
        try
        {
            TxtDisRs.Text = (Convert.ToDouble((Convert.ToDouble(LblAmt.Text) * Convert.ToDouble(TxtDisPer.Text) / 100))).ToString("0.00");
            LblNetRs.Text = (Convert.ToDouble(LblAmt.Text) - Convert.ToDouble(TxtDisRs.Text)).ToString("0.00");
        }
        catch (Exception ex)
        {
    ...
    protected void TxtDisRS_TextChanged(object sender, EventArgs e)
    {
        try
        {
    ...
    protected void txtDiscPerChild_TextChanged(object sender, EventArgs e)
    {
        ...
        LblTotal.Text = (Convert.ToDecimal(TxtSaleRate.Text) * Convert.ToDecimal(TxtQty.Text == "" ? "0" : TxtQty.Text)).ToString("0.00");
        TxtQty.Focus();
    }
