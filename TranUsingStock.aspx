<%@ Page Title="" Language="C#" MasterPageFile="~/BillMaster.master" AutoEventWireup="true" CodeFile="TranUsingStock.aspx.cs" Inherits="TranUsingStock" %>
            ...
            <h2 class="panel-title">
              Using Stock
                <button type="button" name="btnList" id="btnList" runat="server" class="btn btn-info AddList"
                    onclick="location.href = 'ListUsingStock.aspx'" tabindex="10" style="float: right;">
                ...
                <button type="button" name="btnAdd" id="btnAdd" runat="server" class="btn btn-success AddList"
                    onclick="location.href = 'TranUsingStock.aspx'" tabindex="9" style="float: right;
                    margin-right: 4px;">
