...
public partial class TranUsingStock : System.Web.UI.Page
{
    ...
    protected void ImgBtnAdd_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            if (Request.QueryString["id"] != null)
            {
                if (Request.QueryString["cid"] != null)
                {
                    ds = cn.RunSql("sp_addstock 'PUCU','2','" + TxtSRNo.Text + "','" + TxtDate.Text + "','" + HifItem.Value + "','" + TxtTotalQty.Text + "','" + Request.QueryString["id"] + "','" + Request.QueryString["cid"] + "','" + Request.Cookies["CompID"].Value + "','" + Request.Cookies["BranchID"].Value + "','" + Request.Cookies["AccYear"].Value + "'", "puci");
                    Response.Redirect("TranUsingStock.aspx?id=" + ds.Tables[0].Rows[0][0] + "&E=1");
                }
                else
                {
                    ds = cn.RunSql("sp_addstock 'PUCI','2','" + TxtSRNo.Text + "','" + TxtDate.Text + "','" + HifItem.Value + "','" + TxtTotalQty.Text + "','" + Request.QueryString["id"] + "','','" + Request.Cookies["CompID"].Value + "','" + Request.Cookies["BranchID"].Value + "','" + Request.Cookies["AccYear"].Value + "'", "puci");
                    Response.Redirect("TranUsingStock.aspx?id=" + ds.Tables[0].Rows[0][0] + "&E=1");
                }
            }
            else
            {
                ds = cn.RunSql("sp_addstock 'I','2','" + TxtSRNo.Text + "','" + TxtDate.Text + "','" + HifItem.Value + "','" + TxtTotalQty.Text + "','','','" + Request.Cookies["CompID"].Value + "','" + Request.Cookies["BranchID"].Value + "','" + Request.Cookies["AccYear"].Value + "'", "puci");
                Response.Redirect("TranUsingStock.aspx?id=" + ds.Tables[0].Rows[0][0] + "&E=1");
            }
        }
        catch (Exception ex)
    ...
    protected void ImgDelete1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (confirmval == "Yes")
            {
                ...
                ds = cn.RunSql("sp_addstock 'PUCD','2','" + TxtSRNo.Text + "','" + TxtDate.Text + "','" + HifItem.Value + "','" + TxtTotalQty.Text + "','" + Request.QueryString["id"] + "','" + cnid + "','" + Request.Cookies["CompID"].Value + "','" + Request.Cookies["BranchID"].Value + "','" + Request.Cookies["AccYear"].Value + "'", "puci");
                Response.Redirect("TranUsingStock.aspx?id=" + ds.Tables[0].Rows[0][0] + "");
            }
        }
        catch (Exception ex)
        {
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        try
        {
            if (Request.QueryString["D"] == "1")
            {
                ...
                {
                    ds = cn.RunSql("sp_addstock 'D','2','" + TxtSRNo.Text + "','" + TxtDate.Text + "','" + HifItem.Value + "','" + TxtTotalQty.Text + "','" + Request.QueryString["id"] + "','','" + Request.Cookies["CompID"].Value + "','" + Request.Cookies["BranchID"].Value + "','" + Request.Cookies["AccYear"].Value + "'", "puci");
                    Response.Redirect("TranUsingStock.aspx");
                }
            }
            else
            {
                ds = cn.RunSql("sp_addstock 'PU','2','" + TxtSRNo.Text + "','" + TxtDate.Text + "','" + HifItem.Value + "','" + TxtTotalQty.Text + "','" + Request.QueryString["id"] + "','','" + Request.Cookies["CompID"].Value + "','" + Request.Cookies["BranchID"].Value + "','" + Request.Cookies["AccYear"].Value + "'", "puci");
                Response.Redirect("TranUsingStock.aspx");
            }
        }
        catch (Exception ex)
