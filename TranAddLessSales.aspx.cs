    ...
    protected void ImgBtnAdd_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            if (Request.QueryString["ID"] != null)
            {
                ...
                {
                    ds = cn.RunSql("sp_addMasterAddLess 'U','" + Request.QueryString["ID"].ToString() + "','" + TxtDescription.Text + "','" + TxtAccountName.Text + "','" + DdlAddLess.SelectedValue + "','" + TxtPer.Text + "','" + TxtRs.Text + "','" + DDLCountBelow.SelectedValue + "','1','" + DDLType.SelectedValue + "'", "Add");
            ...
            {
                ds = cn.RunSql("sp_addMasterAddLess 'I','','" + TxtDescription.Text + "','" + TxtAccountName.Text + "','" + DdlAddLess.SelectedValue + "','" + TxtPer.Text + "','" + TxtRs.Text + "','" + DDLCountBelow.SelectedValue + "','1','" + DDLType.SelectedValue + "'", "Add");
                BindGrid();
                ClearChild();
            }
        }
