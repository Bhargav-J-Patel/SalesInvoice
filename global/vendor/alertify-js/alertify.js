        ...
        var _alertify = {
            ...
            dialogs: {
                buttons: {
                    ...
                    ok: "<button id='btnAlertifyOK' class='btn btn-primary ok' tabindex='1'>{{ok}}</button>",
                    cancel: "<button id='btnAlertifyCancel' class='btn btn-primary cancel' tabindex='2'>{{cancel}}</button>"
                },
            ...
            theme: function(themeStr) {
                ...
                case "bootstrap":
                    this.dialogs.buttons.ok = "<button id='btnAlertifyOK' class='ok btn btn-primary' tabindex='1'>{{ok}}</button>";
                    this.dialogs.buttons.cancel = "<button id='btnAlertifyCancel' class='cancel btn btn-default' tabindex='2'>{{cancel}}</button>";
                    this.dialogs.input = "<input type='text' class='form-control'>";
                    break;
                case "purecss":
                    this.dialogs.buttons.ok = "<button id='btnAlertifyOK' class='ok pure-button' tabindex='1'>{{ok}}</button>";
                    this.dialogs.buttons.cancel = "<button id='btnAlertifyCancel' class='cancel pure-button' tabindex='2'>{{cancel}}</button>";
                    break;
                case "mdl":
                case "material-design-light":
                    this.dialogs.buttons.ok = "<button id='btnAlertifyOK' class='ok mdl-button mdl-js-button mdl-js-ripple-effect'  tabindex='1'>{{ok}}</button>";
                    this.dialogs.buttons.cancel = "<button id='btnAlertifyCancel' class='cancel mdl-button mdl-js-button mdl-js-ripple-effect' tabindex='2'>{{cancel}}</button>";
                ...
                case "angular-material":
                    this.dialogs.buttons.ok = "<button id='btnAlertifyOK' class='ok md-primary md-button' tabindex='1'>{{ok}}</button>";
                    this.dialogs.buttons.cancel = "<button id='btnAlertifyCancel' class='cancel md-button' tabindex='2'>{{cancel}}</button>";
